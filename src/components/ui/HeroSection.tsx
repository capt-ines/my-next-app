...
const HeroSection = () => {
  return (
    ...
    <section className="flex h-screen items-center">
      <div className="bg-on-background mx-auto flex aspect-square w-full max-w-md min-w-3xs flex-col items-center justify-center rounded-full px-5 shadow-[0_0_50px_var(--color-white)] transition-shadow duration-1000 hover:shadow-[0_0_200px_var(--color-white)] sm:px-10">
        <div>
