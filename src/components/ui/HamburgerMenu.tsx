...
const HamburgerMenu = () => {
  ...
  return (
    <div>
      ...
      {isOpen && (
        <ul className="text-on-background w- absolute top-20 right-10 z-52 flex flex-col gap-3 text-right text-xl transition duration-500 ease-in-out min-[580px]:right-30 min-[580px]:gap-4 min-[580px]:text-2xl">
          <li>Sign in</li>
          <li>Our mission</li>
